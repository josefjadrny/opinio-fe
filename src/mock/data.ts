...
export const SEED_PROFILES: Profile[] = [
  ...
  // Actors
  p('14', 'Keanu Reeves', 'entertainment', 'US', 'Donates entire Matrix salary to cancer research', 8900, 120),
  p('15', 'Leonardo DiCaprio', 'entertainment', 'US', 'Launches new climate change documentary', 4500, 800),
  p('16', 'Margot Robbie', 'entertainment', 'AU', 'Produces new indie film about refugee crisis', 3200, 350),
  p('17', 'Shah Rukh Khan', 'entertainment', 'IN', 'Breaks box office records with latest release', 6100, 700),
  p('18', 'Cate Blanchett', 'entertainment', 'AU', 'Speaks at UN about refugee rights', 2800, 200),
  p('19', 'Will Smith', 'entertainment', 'US', 'Returns to public eye after controversy', 1200, 4200),
  p('20', 'Gal Gadot', 'entertainment', 'IL', 'Controversial social media post about conflict', 1800, 3100),
  p('21', 'Tom Hanks', 'entertainment', 'US', 'Warns about AI-generated deepfakes using his likeness', 5400, 180),
  p('22', 'Penelope Cruz', 'entertainment', 'ES', 'Opens arts foundation for underprivileged youth', 2100, 150),

  // Musicians
  p('23', 'Taylor Swift', 'entertainment', 'US', 'Endorses voter registration, crashes website', 7800, 2100, '/avatars/23.jpg'),
  p('24', 'Bad Bunny', 'entertainment', 'US', 'Speaks out about Puerto Rico recovery efforts', 4100, 600),
  p('25', 'BTS', 'entertainment', 'KR', 'Members begin military service, fans show support', 9200, 300),
  p('26', 'Beyonce', 'entertainment', 'US', 'Announces free concert series in underserved communities', 6500, 800),
  p('27', 'Ed Sheeran', 'entertainment', 'GB', 'Wins copyright lawsuit, speaks against music industry practices', 3200, 500),
  p('28', 'Shakira', 'entertainment', 'CO', 'Tax fraud case resolved, releases diss track', 3800, 1200),
  p('29', 'Kanye West', 'entertainment', 'US', 'Makes controversial antisemitic statements', 1100, 8900),
  p('30', 'Adele', 'entertainment', 'GB', 'Announces residency cancellation, fans outraged', 2800, 1900),
  p('31', 'Rihanna', 'entertainment', 'US', 'Expands Fenty brand to 15 new countries', 5200, 400),
  ...
  p('85', 'Florian Silbereisen', 'entertainment', 'DE', 'Record-breaking TV special draws 12M viewers', 1600, 800),
  ...
  p('88', 'Til Schweiger', 'entertainment', 'DE', 'Refugee shelter donations spark admiration', 2200, 900),
  p('89', 'Bushido', 'entertainment', 'DE', 'Mob ties exposed, public trust shattered', 800, 4100),
