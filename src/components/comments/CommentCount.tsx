...
// The opinio glyph: the same bubble with a plus, as on the header's Opinio
// button, the FAB and the add modal (each inlines its own copy).
export function OpinioIcon({ className = 'w-3.5 h-3.5' }: { className?: string }) {
  return (
