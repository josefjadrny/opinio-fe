...
const en: Strings = {
  ...
  statementHint: 'The line people vote like or dislike on - add a photo to give it a face.',
  linkAdd: 'Add link',
  linkLabel: 'Link',
...
const cs: Strings = {
  ...
  statementHint: 'Věta, kterou lidé lajkují nebo dislajkují - přidejte fotku, ať má tvář.',
...
const es: Strings = {
  ...
  statementHint: 'La frase que la gente vota a favor o en contra - añade una foto para ponerle cara.',
...
const de: Strings = {
  ...
  statementHint: 'Der Satz, den Leute mit Like oder Dislike bewerten - füge ein Foto hinzu, um ihm ein Gesicht zu geben.',
...
const fr: Strings = {
  ...
  statementHint: 'La phrase que les gens votent pour ou contre - ajoutez une photo pour lui donner un visage.',
...
const it: Strings = {
  ...
  statementHint: 'La frase su cui le persone votano mi piace o non mi piace - aggiungi una foto per darle un volto.',
...
const pl: Strings = {
  ...
  statementHint: 'Zdanie, które ludzie lajkują lub dislajkują - dodaj zdjęcie, by nadać mu twarz.',
  linkAdd: 'Dodaj link',
  linkLabel: 'Link',
  linkPlaceholder: 'https://...',
  linkPaste: 'Wklej',
