export interface Strings {
  ...
  // The same two panels on /c/:code, where the figures sum every opinio ABOUT
  // the country: the agree line names the country as the thing being liked
  ...
  linkCopied: string;
  seeOriginal: string;
  // Comments on an opinio. Count labels by plural category (one=1, few=2-4, many=5+).
  comments: string;
  commentsCountOne: string;
  commentsCountFew: string;
  commentsCountMany: string;
  commentsTabCountries: string;
  commentsTabComments: string;
...
const en: Strings = {
  ...
  voteTipAgreeHelp: '{percent}% of voters in the {window} like this opinio.',
  ...
  comments: 'Comments',
  commentsCountOne: '{n} comment',
  commentsCountFew: '{n} comments',
  commentsCountMany: '{n} comments',
  commentsTabCountries: 'Countries',
  commentsTabComments: 'Comments',
  commentsEmpty: 'No comments yet',
  commentsWrite: 'Write a comment',
  commentsPlaceholder: 'Say why... use @ to mention someone',
  commentsSend: 'Send',
...
const cs: Strings = {
  ...
  voteTipAgreeHelp: 'Toto opinio se líbí {percent} % hlasujících za {window}.',
  ...
  comments: 'Komentáře',
  commentsCountOne: '{n} komentář',
  commentsCountFew: '{n} komentáře',
  commentsCountMany: '{n} komentářů',
  commentsTabCountries: 'Země',
...
const es: Strings = {
  ...
  voteTipAgreeHelp: 'Al {percent} % de los votantes de las {window} les gusta este opinio.',
  ...
  commentsCountOne: '{n} comentario',
  commentsCountFew: '{n} comentarios',
  commentsCountMany: '{n} comentarios',
  commentsTabCountries: 'Países',
  commentsTabComments: 'Comentarios',
  commentsEmpty: 'Aún no hay comentarios',
  commentsWrite: 'Escribir un comentario',
  commentsPlaceholder: 'Di por qué... usa @ para mencionar a alguien',
  commentsSend: 'Enviar',
...
const de: Strings = {
  ...
  voteTipAgreeHelp: '{percent} % der Abstimmenden der {window} gefällt dieses opinio.',
  ...
  comments: 'Kommentare',
  commentsCountOne: '{n} Kommentar',
  commentsCountFew: '{n} Kommentare',
  commentsCountMany: '{n} Kommentare',
  commentsTabCountries: 'Länder',
  commentsTabComments: 'Kommentare',
  commentsEmpty: 'Noch keine Kommentare',
  commentsWrite: 'Kommentar schreiben',
  commentsPlaceholder: 'Sag warum... @ um jemanden zu erwähnen',
  commentsSend: 'Senden',
...
const fr: Strings = {
  ...
  voteTipAllTime: 'Total',
  voteTipAgreeHelp: '{percent} % des votants des {window} aiment cet opinio.',
  ...
  commentsCountOne: '{n} commentaire',
  commentsCountFew: '{n} commentaires',
  commentsCountMany: '{n} commentaires',
  commentsTabCountries: 'Pays',
  commentsTabComments: 'Commentaires',
  commentsEmpty: 'Pas encore de commentaires',
  commentsWrite: 'Écrire un commentaire',
  commentsPlaceholder: 'Dites pourquoi... @ pour mentionner quelqu\'un',
...
const it: Strings = {
  ...
  voteTipAgreeHelp: 'Al {percent} % dei votanti delle {window} piace questo opinio.',
  ...
  comments: 'Commenti',
  commentsCountOne: '{n} commento',
  commentsCountFew: '{n} commenti',
  commentsCountMany: '{n} commenti',
  commentsTabCountries: 'Paesi',
  commentsTabComments: 'Commenti',
  commentsEmpty: 'Ancora nessun commento',
  commentsWrite: 'Scrivi un commento',
  commentsPlaceholder: 'Di\' perché... @ per menzionare qualcuno',
  commentsSend: 'Invia',
...
const pl: Strings = {
  ...
  voteTipAgreeHelp: 'To opinio podoba się {percent} % głosujących z {window}.',
  ...
  comments: 'Komentarze',
  commentsCountOne: '{n} komentarz',
  commentsCountFew: '{n} komentarze',
  commentsCountMany: '{n} komentarzy',
  commentsTabCountries: 'Kraje',
  commentsTabComments: 'Komentarze',
  commentsEmpty: 'Brak komentarzy',
  commentsWrite: 'Napisz komentarz',
  commentsPlaceholder: 'Powiedz dlaczego... @ aby oznaczyć kogoś',
  commentsSend: 'Wyślij',
