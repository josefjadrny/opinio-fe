...
const it: Strings = {
  ...
  statsCategoryVoters: 'Migliori votanti',
  statsCategoryProfiles: 'Opinios di tendenza',
  statsCategoryCountries: 'Paesi di tendenza',
  statsVotersDescription: 'I membri più attivi della community, in classifica per numero totale di voti espressi (mi piace e non mi piace combinati, da sempre).',
