...
const en: Strings = {
  ...
  statsCategoryProfiles: '🔥 Trending Opinions',
...
const es: Strings = {
  ...
  privacyThirdPartiesBody: 'No vendemos, alquilamos ni compartimos tus datos. Los servidores funcionan en Amazon Web Services. El inicio de sesión lo gestiona Google como proveedor de identidad — para ese paso se aplica la política de privacidad de Google. Los pagos los procesa Stripe — cuando te suscribes, los datos de tu tarjeta y de facturación los recopila y almacena Stripe según su política de privacidad. Cloudflare actúa como proxy del tráfico y detecta tu país a partir de tu IP.',
  privacyRetentionTitle: 'Conservación',
  privacyRetentionVotes: 'Los votos se eliminan a las 24 horas.',
  privacyRetentionProfiles: 'Los perfiles sin votos tras 3 días se eliminan automáticamente.',
  ...
  statsCategoryProfiles: '🔥 Opiniones en tendencia',
