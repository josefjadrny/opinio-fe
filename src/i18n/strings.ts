...
const cs: Strings = {
  ...
  aboutHero: 'Opinio je sociální hlasovací platforma z Evropy 🇪🇺. Hlasujte o tématech, která utvářejí dnešní svět.',
  ...
  welcomeIntro: 'Opinio je sociální hlasovací platforma z Evropy 🇪🇺. Hlasuj o tématech, která utvářejí dnešní svět.',
...
const es: Strings = {
  ...
  aboutHero: 'Opinio es una plataforma de votación social desde Europa 🇪🇺. Vota sobre las historias que dan forma al mundo hoy.',
  ...
  welcomeIntro: 'Opinio es una plataforma de votación social desde Europa 🇪🇺. Vota sobre las historias que dan forma al mundo hoy.',
