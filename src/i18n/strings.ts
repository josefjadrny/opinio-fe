export interface Strings {
  ...
  statsVoterMetricLabel: string;
  statsVoterMetricGiven: string;
  statsVoterMetricReceived: string;
  statsVotersReceivedDescription: string;
  statsVotesCast: string;
...
const en: Strings = {
  ...
  statsVotersDescription: 'Most active community members ranked by total lifetime votes cast (likes and dislikes combined).',
  statsVotersReceivedDescription: 'Most influential members ranked by total lifetime votes received on their opinios (likes and dislikes combined).',
  ...
  statsMetricNet: 'Net',
  statsVoterMetricLabel: 'Rank by',
  statsVoterMetricGiven: 'Votes given',
  statsVoterMetricReceived: 'Votes received',
...
const cs: Strings = {
  ...
  statsVotersDescription: 'Nejaktivnější hlasující, seřazení podle celkového počtu lajků a dislajků udělených za celou dobu.',
  statsVotersReceivedDescription: 'Nejvlivnější členové komunity podle celkového počtu hlasů, které za celou dobu získaly jejich opinia.',
  ...
  statsVoterMetricLabel: 'Řadit podle',
  statsVoterMetricGiven: 'Hlasů dáno',
  statsVoterMetricReceived: 'Hlasů přijato',
  statsVotesCast: 'hlasů dáno',
  statsVotesReceived: 'hlasů přijato',
  statsVotes: 'hlasů',
  statsLikes: 'lajků',
...
const es: Strings = {
  ...
  statsVotersDescription: 'Miembros más activos clasificados por el total histórico de votos emitidos (positivos y negativos combinados).',
  statsVotersReceivedDescription: 'Miembros más influyentes clasificados por el total histórico de votos recibidos en sus opinios.',
  ...
  statsMetricNet: 'Neto',
  statsVoterMetricLabel: 'Ordenar por',
  statsVoterMetricGiven: 'Votos emitidos',
  statsVoterMetricReceived: 'Votos recibidos',
  statsVotesCast: 'votos emitidos',
...
const de: Strings = {
  ...
  statsVotersDescription: 'Aktivste Mitglieder, sortiert nach der Gesamtzahl abgegebener Stimmen (Likes und Dislikes zusammen, gesamte Laufzeit).',
  statsVotersReceivedDescription: 'Einflussreichste Mitglieder, sortiert nach der Gesamtzahl der erhaltenen Stimmen auf ihren Opinios (gesamte Laufzeit).',
  ...
  statsVoterMetricLabel: 'Sortieren nach',
  statsVoterMetricGiven: 'Abgegebene Stimmen',
  statsVoterMetricReceived: 'Erhaltene Stimmen',
  statsVotesCast: 'abgeg. Stimmen',
  statsVotesReceived: 'erh. Stimmen',
  statsVotes: 'Stimmen',
  statsLikes: 'Likes',
  statsDislikes: 'Dislikes',
  statsNet: 'Netto',
...
const fr: Strings = {
  ...
  statsVotersDescription: "Membres les plus actifs, classés par nombre total de votes émis (j'aime et je n'aime pas combinés, depuis toujours).",
  statsVotersReceivedDescription: "Membres les plus influents, classés par nombre total de votes reçus sur leurs opinios (depuis toujours).",
  ...
  statsMetricNet: 'Net',
  statsVoterMetricLabel: 'Classer par',
  statsVoterMetricGiven: 'Votes émis',
  statsVoterMetricReceived: 'Votes reçus',
  statsVotesCast: 'votes émis',
  statsVotesReceived: 'votes reçus',
  statsVotes: 'votes',
  statsLikes: "j'aime",
...
const it: Strings = {
  ...
  statsVotersDescription: 'I membri più attivi, in classifica per numero totale di voti espressi (mi piace e non mi piace combinati, da sempre).',
  statsVotersReceivedDescription: 'I membri più influenti della community, in classifica per numero totale di voti ricevuti sui loro opinios (da sempre).',
  statsProfilesDescription: 'I membri dietro le opinioni più votate in questo momento - in classifica per numero totale di voti ricevuti sui loro contenuti attivi nelle ultime 24 ore, mi piace e non mi piace combinati.',
  statsCountriesDescription: 'I paesi che fanno più parlare di sé in questo momento - in classifica per voti ricevuti sui loro contenuti attivi nelle ultime 24 ore.',
  statsMetricLabel: 'Ordina per',
  statsMetricTotal: 'Totale',
  statsMetricLikes: 'Mi piace',
  statsMetricDislikes: 'Non mi piace',
  statsMetricNet: 'Netto',
  statsVoterMetricLabel: 'Ordina per',
  statsVoterMetricGiven: 'Voti espressi',
  statsVoterMetricReceived: 'Voti ricevuti',
  statsVotesCast: 'voti espressi',
  statsVotesReceived: 'voti ricevuti',
  statsVotes: 'voti',
  statsLikes: 'mi piace',
...
const pl: Strings = {
  ...
  statsVotersDescription: 'Najaktywniejsi członkowie społeczności w rankingu według łącznej liczby oddanych głosów (polubienia i niechęci razem).',
  statsVotersReceivedDescription: 'Najbardziej wpływowi członkowie w rankingu według łącznej liczby głosów otrzymanych na ich opinie (polubienia i niechęci razem).',
  statsProfilesDescription: 'Osoby stojące za najczęściej ocenianymi opiniami w tej chwili - w rankingu według łącznej liczby głosów otrzymanych na ich aktywnych wpisach w ciągu ostatnich 24 godzin, polubienia i niechęci razem.',
  statsCountriesDescription: 'Kraje, o których teraz najgłośniej - w rankingu według głosów otrzymanych na ich aktywnych wpisach w ciągu ostatnich 24 godzin.',
  ...
  statsVoterMetricLabel: 'Sortuj według',
  statsVoterMetricGiven: 'Głosy oddane',
  statsVoterMetricReceived: 'Głosy otrzymane',
  statsVotesCast: 'oddanych głosów',
  statsVotesReceived: 'otrzymanych głosów',
  statsVotes: 'głosów',
  statsLikes: 'polubień',
